...
1. **[Installation](installation.md)** — clone it, start it, and confirm it is up.
...
Once a customer exists and somebody can sign in to it, [The Basics](../the-basics/index.md)
